...
# Define the seven eta, pT bins. The quark and gluon jets are also separated at this step.
CUT1_Q="(jetPt>30)&&(jetPt<100)&&(fabs(jetEta<1.3))&&(jetTightID==1)&&(isPhysUDS==1)"
CUT2_Q="(jetPt>100)&&(jetPt<300)&&(fabs(jetEta<1.3))&&(jetTightID==1)&&(isPhysUDS==1)"
CUT3_Q="(jetPt>300)&&(jetPt<1000)&&(fabs(jetEta<1.3))&&(jetTightID==1)&&(isPhysUDS==1)"
CUT4_Q="(jetPt>1000)&&(fabs(jetEta<1.3))&&(jetTightID==1)&&(isPhysUDS==1)"
CUT5_Q="(jetPt>30)&&(jetPt<100)&&(fabs(jetEta>1.3))&&(fabs(jetEta<2.5))&&(jetTightID==1)&&(isPhysUDS==1)"
CUT6_Q="(jetPt>100)&&(jetPt<300)&&(fabs(jetEta>1.3))&&(fabs(jetEta<2.5))&&(jetTightID==1)&&(isPhysUDS==1)"
CUT7_Q="(jetPt>300)&&(jetPt<1000)&&(fabs(jetEta>1.3))&&(fabs(jetEta<2.5))&&(jetTightID==1)&&(isPhysUDS==1)"
CUT1_G="(jetPt>30)&&(jetPt<100)&&(fabs(jetEta<1.3))&&(jetTightID==1)&&(isPhysG==1)"
CUT2_G="(jetPt>100)&&(jetPt<300)&&(fabs(jetEta<1.3))&&(jetTightID==1)&&(isPhysG==1)"
CUT3_G="(jetPt>300)&&(jetPt<1000)&&(fabs(jetEta<1.3))&&(jetTightID==1)&&(isPhysG==1)"
CUT4_G="(jetPt>1000)&&(fabs(jetEta<1.3))&&(jetTightID==1)&&(isPhysG==1)"
CUT5_G="(jetPt>30)&&(jetPt<100)&&(fabs(jetEta>1.3))&&(fabs(jetEta<2.5))&&(jetTightID==1)&&(isPhysG==1)"
CUT6_G="(jetPt>100)&&(jetPt<300)&&(fabs(jetEta>1.3))&&(fabs(jetEta<2.5))&&(jetTightID==1)&&(isPhysG==1)"
CUT7_G="(jetPt>300)&&(jetPt<1000)&&(fabs(jetEta>1.3))&&(fabs(jetEta<2.5))&&(jetTightID==1)&&(isPhysG==1)"
